...
/**
 * @typedef {{ image: string, link: string, title: string, description: string }} InfiniteMenuItem
 * @typedef {{ items?: InfiniteMenuItem[] }} InfiniteMenuProps
 * @param {InfiniteMenuProps} props
 */
